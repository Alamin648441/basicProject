...
<body>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <a href="{{route('studentView')}}" class="btn btn-outline-primary">Student list</a>
        </div>
    </nav>
    ...
    <div class="container my-5">
        ...
        <div class="form-card mx-auto" style="max-width: 700px;">
            <form action="{{route('update',$editStudent->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <button type="button" onclick="history.back()"
                            class="btn btn-outline-primary w-100 mt-4">Back</button>
                    </div>
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-outline-primary w-100 mt-4">Update info</button>
